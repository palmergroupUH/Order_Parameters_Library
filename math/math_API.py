...
fortranlib_address = os.path.join(os.path.dirname(math_API.__file__), "lib")
...
def compute_spherical_harmonics(l,cos_theta, cos_sin_phi, m=None):
    ...
    cos_sin_phi_c = np.ctypeslib.as_ctypes(cos_sin_phi)
