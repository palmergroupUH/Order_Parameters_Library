SUBROUTINE calc_q3_cluster(n_atoms,n_q3_neigh,q3_cutoff,n_bonds,box,x,largest_cluster) bind(c, name="call_calc_q3_cluster") 
  ...
  INTEGER(c_int), INTENT(IN) :: n_q3_neigh
  INTEGER(c_int), INTENT(IN) :: n_bonds
  REAL(c_double), INTENT(IN) :: q3_cutoff
  !DOUBLE PRECISION,INTENT(IN) :: box
  REAL(c_double), INTENT(IN), dimension(1:3) :: box
  REAL(c_double), INTENT(IN),DIMENSION(0:3*n_atoms-1) :: x
  INTEGER(c_int),INTENT(OUT) :: largest_cluster
